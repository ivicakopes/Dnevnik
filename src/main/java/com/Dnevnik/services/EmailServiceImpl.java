...
public class EmailServiceImpl implements EmailService {
	...
	public void sendSimpleMessage(EmailObject object) {
		...
		message.setSubject(object.getTo());
	...
	@Override
	public void sendMessageWithAttachment(EmailObject object, String pathToAtachment) throws Exception {
		MimeMessage mail = emailSender.createMimeMessage();
		MimeMessageHelper helper = new MimeMessageHelper(mail,true);
		helper.setTo(object.getTo());
		helper.setSubject(object.getSubject());
		helper.setText(object.getText(),false);
		FileSystemResource file = new FileSystemResource(new File(pathToAtachment));
